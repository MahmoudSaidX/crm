...
using SquadCrm.Modules.TicketManagement.Domain.Events;
using SquadCrm.Modules.TicketManagement.Infrastructure.Persistence;

namespace SquadCrm.Modules.TicketManagement.Infrastructure.Outbox;
    ...
    : SaveChangesInterceptor
{
    ...
    private static IIntegrationEvent Translate(IDomainEvent domainEvent) => domainEvent switch
    {
        ...
        TicketAssignedDomainEvent assigned => new TicketAssignedIntegrationEvent(
            Guid.NewGuid(),
            assigned.TicketId,
            assigned.TicketNumber,
            assigned.PreviousAgentId,
            assigned.NewAgentId,
            assigned.Reason,
            assigned.Source,
        ...
        TicketEscalatedDomainEvent escalated => new TicketEscalatedIntegrationEvent(
            Guid.NewGuid(),
            escalated.TicketId,
            escalated.TicketNumber,
            escalated.PreviousLevel,
            escalated.NewLevel,
            escalated.TargetType.ToString(),
            escalated.TargetId,
            escalated.Reason,

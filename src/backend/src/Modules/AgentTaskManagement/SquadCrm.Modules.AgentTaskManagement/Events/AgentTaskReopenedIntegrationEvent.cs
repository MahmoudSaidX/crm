...
/// <summary>
/// Explicit, versionable cross-module/external contract for a reopened agent
...
/// </summary>
internal sealed record AgentTaskReopenedIntegrationEvent(
    Guid EventId,
    Guid TaskId,
    string Title,
    Guid OwnerUserId,
    DateTimeOffset OccurredAtUtc) : IIntegrationEvent
{
    ...
    public const string ContractName = "agent-task-management.agent-task-reopened.v1";

...
export const COMMON_TRANSLATIONS = {
  en: {
    ...
    'common.navigation.moreActions': 'More actions',
    'common.theme.toggle': 'Toggle light and dark mode',
    'common.states.loading': 'Loading…',
    'common.states.empty': 'Nothing to show yet.',
  ...
  ar: {
    ...
    'common.navigation.moreActions': 'إجراءات إضافية',
    'common.theme.toggle': 'تبديل الوضع الفاتح والداكن',
    'common.states.loading': 'جارٍ التحميل…',
    'common.states.empty': 'لا توجد بيانات لعرضها بعد.',
